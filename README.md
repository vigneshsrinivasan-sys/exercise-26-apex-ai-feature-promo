...
**Primary practice:** Multi-section product-page systems

## What I built

The Apex AI page combines utility classes, grid and flex composition, responsive media rules, layered surfaces, gradients, pseudo-elements, and dashboard imagery across multiple sections.
